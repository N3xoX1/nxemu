...
public:
    ...
    bool SetupCurrentProcess(uint64_t codeSize, const IProgramMetadata & metaData, uint64_t aslr_space_start, uint64_t & baseAddress, uint64_t & processID, bool is_hbl) override;
    IKernelProcess * CurrentProcess() override;
